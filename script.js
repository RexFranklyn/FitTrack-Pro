...
const mobileWorkoutsBtn = document.getElementById('mobileWorkoutsBtn');
...
function setupEventListeners() {
    ...
    document.getElementById('goalDeadline').valueAsDate = defaultDeadline;
     ...
     mobileDashboardBtn.addEventListener('click', () => {
         setActiveTab(dashboardBtn, dashboardTab);
         closeMobileMenu();
     });
     mobileWorkoutsBtn.addEventListener('click', () => {
         setActiveTab(workoutsBtn, workoutsTab);
         closeMobileMenu();
     });
     mobileGoalsBtn.addEventListener('click', () => {
         setActiveTab(goalsBtn, goalsTab);
         closeMobileMenu();
     });
 }
